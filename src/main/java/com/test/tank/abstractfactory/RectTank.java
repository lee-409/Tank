...
//        fs.fire(this);
    ...
    private void boundsCheck() {
        ...
        if (this.x > TankFrame.GAME_WIDTH - com.test.tank.Tank.WIDTH - 2){
            x = TankFrame.GAME_WIDTH - com.test.tank.Tank.WIDTH - 2;
        }
        if (this.y > TankFrame.GAME_HEIGHT - com.test.tank.Tank.HEIGHT - 2){
